# Autogenerated wrapper script for TauDEM_jll for armv7l-linux-musleabihf-cxx03-mpi+mpich
...
function __init__()
    JLLWrappers.@generate_init_header(GDAL_jll, MPICH_jll, MPIPreferences)

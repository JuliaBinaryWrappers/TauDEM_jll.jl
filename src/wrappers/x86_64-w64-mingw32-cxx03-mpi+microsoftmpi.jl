# Autogenerated wrapper script for TauDEM_jll for x86_64-w64-mingw32-cxx03-mpi+microsoftmpi
...
function __init__()
    JLLWrappers.@generate_init_header(GDAL_jll, MicrosoftMPI_jll, MPIPreferences)
